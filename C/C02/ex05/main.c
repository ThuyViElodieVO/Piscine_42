...
/*   Updated: 2023/07/18 14:13:22 by thuvo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	printf("Resultat str_lowercase_letter : %d\n", ft_str_is_uppercase(str_lowercase_letter));

	char	str_capital_letter[] = "QWERTYUIOOP";
	printf("Resultat str_capital_letter : %d\n", ft_str_is_uppercase(str_capital_letter));

	char	str_positive_digit[] = "12345";
	printf("Resultat str_positive_digit : %d\n", ft_str_is_uppercase(str_positive_digit));

	char	str_zero[] = "0";
	ft_str_is_uppercase(str_zero);
	printf("Resultat str_zero : %d n", ft_str_is_uppercase(str_zero));
	
	char	str_char[] = "%^&";
	printf("Resultat str_char : %d\n", ft_str_is_uppercase(str_char));

	char	str_blend[] = "5zxcvg5698&^%$";
	printf("Resultat str_blend : %d\n", ft_str_is_uppercase(str_blend));
